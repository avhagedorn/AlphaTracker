    ...
    return (
        <div>
            ...
            <Table
                className={"mt-4"}
                headers={[
                    { name: 'Ticker', sort: (a: PositionRow, b: PositionRow) => b.ticker.localeCompare(a.ticker) },
                    { name: 'Equity', sort: (a: PositionRow, b: PositionRow) => a.equityValueDollars - b.equityValueDollars },
